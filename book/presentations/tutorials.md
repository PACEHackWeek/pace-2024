...
| [Using the SeaDAS Command Line Tools (OCSSW)](./hackweek/ocssw_processing.ipynb)  | {fas}`eye;sd-text-light` |  [{fas}`download;sd-text-primary`][ocssw-nb] | {fab}`youtube;sd-text-light` |
